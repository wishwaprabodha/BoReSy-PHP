...
<div class="login" >
    <div class="wrap" style="padding-left: 5%">
        <!-- TOGGLE -->
        ...
        <div class="user" style="width: 100%">
            ...
            <div class="form-wrap">
                <!-- TABS -->
                <div class="tabs" style="padding-left: 20%">

                    <h3 style="padding-left: 10%"><a class="sign-up" href="#signup-tab-content">Add Place</a></h3>
                </div>
                <!-- TABS CONTENT -->
                <div class="tabs-content">
                    ...
                    <div id="signup-tab-content">
                        <form class="signup-form" action="/AddPlace.php" method="post">
                            <input type="text" class="input" name="rental" autocomplete="off" placeholder="Rental">
                            <input type="text" class="input" name="capacity" autocomplete="off" placeholder="Capacity">
                            <input type="text" class="input" name="advance" autocomplete="off" placeholder="Advance">
                            <input type="text" class="input" name="name" autocomplete="off" placeholder="Owner Id">
                            <br><br>
                            <button class="button" onclick="alert('Button clicked')">Add</button>
                        </form>
...
<script >/* LOGIN - MAIN.JS - dp 2017 */
    ...
    function loadImage(){
        ...
        var filesSelected = document.getElementById("vid").files;
...

        {
            ...
            if (fileToLoad.type.match("image.*"))
            {
                ...
                {
                    var imageLoaded = document.getElementById("imgID");
                    var divi = document.getElementById("imgDiv");
                    imageLoaded.src = fileLoadedEvent.target.result;
                    document.divi.appendChild(imageLoaded);
                };
...
if (isset($_POST['submit'])) {
    ...
    $sqlInsert = "INSERT INTO place VALUES( $placeid, $rental,$capacity,$advance,$id) ;";
    echo($sqlInsert);
