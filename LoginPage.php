...
if (isset($_POST["submit"])) {
    ...
    $sqlInsert = "INSERT INTO user VALUES( $userid, '$fullname','$address','$contact','$nic','$email','$username','$password','$type','$sex') ;";
    echo($sqlInsert);
    $retval = mysqli_query($conn, $sqlInsert);
    if (!$retval) {
        die('Could not send data: ' . mysqli_error($retval));
    }
}
...
<head>
    ...
    <style class="cp-pen-styles">@import url(https://fonts.googleapis.com/css?family=Raleway:400,100,200,300);
        ...
        *, *:before, *:after {
        ...
        .form-wrap form .radio:checked + label:after {
            -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=100)";
            filter: alpha(opacity=100);
            opacity: 1;
        }
...
<div class="login">
    <div class="wrap">
        ...
        <div class="content">
            ...
            <div id="slideshow">
                <div class="one">
                    <h2><span>BoReSy</span></h2>
                    <p>Boarding Reservation System for University Undergraduates & Academic/Non Academic Staff to find a place to stay more conveniently.</p>
                </div>
                <div class="two">
                    <a href="AddPlace.html"> <h4><span>Place To RENT?</span></h4></a>
                    <p>Register as a place owner and make it more easy to find client.</p>
                </div>
                <div class="three">
                    <a href="SearchPlace.html"><h4><span>Place to STAY?</span></h4>
                        <p>Ideal way to find a place to stay.Register now and just search for your requirement.</p></a>
                </div>
                <div class="four">
                    <h2><span>About US</span></h2>
                    <p>This System is implemented for Semester Project System Analysis and Design, Department of Statistics and Computer Science, Faculty of Science, University
                        of Kelaniya, Sri Lanka.</p>
                </div>
            </div>
        </div>
        <!-- LOGIN FORM -->
                ...
                <div class="tabs-content">
                    ...
                    <div id="login-tab-content" class="active">
                        <form class="login-form" action="" method="post">
                            ...
                            <input type="password" class="input" name="user_password" autocomplete="off" placeholder="Password">
                            <input type="checkbox" class="checkbox" checked id="remember_me">
                            <label for="remember_me">Remember me</label>
                            <input type="submit" class="button" name="user" value="Login">
                        </form>
                    ...
                    <div id="signup-tab-content">
                        <form class="signup-form" action="" method="post">
                            <input type="text" class="input" name="name"  autocomplete="off" placeholder="Fullname">
                            <input type="text" class="input" name="address" autocomplete="off" placeholder="Address">
                            <input type="text" class="input" name="contact" autocomplete="off" placeholder="Contact">
                            <input type="text" class="input" name="nic" autocomplete="off" placeholder="NIC">
                            ...
                            <input type="radio" class="radio" name="ty" id="Owner" ><label style="padding-right: 10%" for="Owner">Owner</label>
                            <input type="radio" class="radio" name="ty" id="Seeker"  ><label style="padding-right: 10%" for="Seeker">Seeker</label><br>
                            <input type="radio" class="radio" name="gender" value="M" id="male" ><label style="padding-right: 10%" for="male">Male</label>
                            <input type="radio" class="radio" name="gender" value="F" id="female"><label style="padding-right: 10%" for="female">Female</label>

                            <br><br>
                            <input type="submit" class="button" name="user" value="SignUp">
                        </form>
                        <div class="help-action">
...
<!-- content display (Change the size)-->
